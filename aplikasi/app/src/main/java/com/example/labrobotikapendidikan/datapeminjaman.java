...
public class datapeminjaman extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text6 =(TextView) findViewById(R.id.lihatnowa);
        text7 = (TextView) findViewById(R.id.lihattanggal);
        text8 = (TextView) findViewById(R.id.lihatjam);
        text9 = (TextView) findViewById(R.id.lihatlama);
        text10 = (TextView) findViewById(R.id.lihatfasilitas);
        text11 = (TextView) findViewById(R.id.lihatjumlah);
        text12 = (TextView) findViewById(R.id.lihatketerangan);
